import { CheckinRecord, UserInfo, PageData } from '../../types/index';
...
Page({
  ...
  async updatePageData(): Promise<void> {
  ...
  // 快速打卡
  async quickCheckin(): Promise<void> {
    ...
    try {
      const record: Omit<CheckinRecord, '_id'> = {
        timestamp: Date.now(),
